...
let
  ...
  in rec {
    ...
    fourmolu-0-13-0 = justStaticExecutables (haskell.packages.ghc96.override {
    ...
    fourmolu-0-13-1 = justStaticExecutables (haskell.packages.ghc96.override {
      overrides = self: super: {
        fourmolu = overrideCabal
  ...
  in rec {
    ...
    fourmolu-0-14-0 = justStaticExecutables (haskell.packages.ghc96.override {
      overrides = self: super: {
        fourmolu = overrideCabal
