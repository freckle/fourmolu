...
let
  ...
  ghcCheck = { packageName, ghc, weeder ? null, hls ? null }: testEqualContents {
...
in
{
  ...
  ghc-9-4-7 = ghcCheck { packageName = "ghc-9-4-7"; ghc = "9.4.7"; weeder = "2.8.0"; hls = "2.8.0.0"; };
  ghc-9-4-8 = ghcCheck { packageName = "ghc-9-4-8"; ghc = "9.4.8"; weeder = "2.8.0"; hls = "2.8.0.0"; };
  ...
  ghc-9-6-6 = ghcCheck { packageName = "ghc-9-6-6"; ghc = "9.6.6"; weeder = "2.8.0"; hls = "2.9.0.0"; };
  ghc-9-8-1 = ghcCheck { packageName = "ghc-9-8-1"; ghc = "9.8.1"; weeder = "2.8.0"; hls = "2.8.0.0"; };
  ghc-9-8-2 = ghcCheck { packageName = "ghc-9-8-2"; ghc = "9.8.2"; weeder = "2.8.0"; hls = "2.8.0.0"; };
  ghc-9-10-1 = ghcCheck { packageName = "ghc-9-10-1"; ghc = "9.10.1"; };
}
